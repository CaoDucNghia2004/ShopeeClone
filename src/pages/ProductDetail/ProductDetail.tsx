...
export default function ProductDetail() {
  ...
  return (
    <div className='bg-gray-200 py-6'>
          ...
          <div className='grid grid-cols-12 gap-9'>
                ...
                {currentImages.map((img) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%] ' key={img} onMouseEnter={() => chooseActive(img)}>
                      ...
                      />
                      {isActive && <div className='absolute inset-0 border-2 border-orange-400'></div>}
                    </div>
                  )
                })}
                <button
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                <div className='flex items-center'>
                  ...
                  <ProductRating
                    ...
                    nonActiveClassname='fill-gray-300 text-gray-300 h-4 h-4 '
                  />
                </div>
              ...
              <div className='mt-8 flex items-center'>
                <button
                  onClick={addToCart}
                  className='flex h-12 items-center justify-center rounded-sm border border-orange-500 bg-orange-500/10 px-5 capitalize text-orange-400 shadow-sm hover:bg-orange-400/5'
                >
                  <svg
      ...
      <div className='mt-8'>
        <div className='max-w-7xl mx-auto px-4'>
          <div className='uppercase text-gray-400'>Cớ thể bạn cũng thích</div>
          {productsData && (
