        ...
        <div className='flex items-center flex-wrap gap-2'>
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-orange-500 text-white hover:bg-orange-400': isActiveSortBy(sortBy.view),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-orange-500 text-white hover:bg-orange-400': isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-orange-500 text-white hover:bg-orange-400': isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames('h-8  px-4 text-left text-sm capitalize  outline-none ', {
              'bg-orange-500 text-white hover:bg-orange-400': isActiveSortBy(sortBy.price),
