...
export default function AsideFilter({ queryConfig, categories }: Props) {
  ...
  // console.log(category, queryConfig)
  const {
    control,
    handleSubmit,
    trigger,
  ...
  return (
    <div className='py-4'>
      ...
      <div className='bg-gray-300 h-[1px] my-4'></div>
      <div className='my-5'>
        <div className='font-semibold'>Khoản giá</div>
        <form className='mt-2' onSubmit={onSubmit}>
          ...
          <Button className='w-full p-2 uppercase bg-orange-500 text-white text-sm hover:bg-orange-400 flex justify-center items-center'>
            Áp dụng
          </Button>
        </form>
      </div>
      ...
      <Button
        ...
        className='w-full p-2 uppercase bg-orange-500 text-white text-sm hover:bg-orange-400 flex justify-center items-center'
      >
        Xóa tất cả
      </Button>
    </div>
